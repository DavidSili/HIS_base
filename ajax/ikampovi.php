...
while ($row2=$result2->fetch_assoc()) {
	...
	if (in_array($idi, $prisutniy)) {
		$prisutni1.='<li class="ui-state-highlight" id="'.$idi.'" style="overflow:hidden"><div class="shorten">'.$prezime.' '.$ime.' ('.$godina.', '.$odred.')</div><img src="upload_pic/T_2_'.$oid.'.jpg" style="float:right;height:15px;opacity:0.6" /></li>';
	}
	elseif (in_array($idi,$neplatili)) {
		$prisutnis.='<li class="ui-state-neplatise" id="'.$idi.'" style="overflow:hidden"><div class="shorten">'.$prezime.' '.$ime.' ('.$godina.', '.$odred.')</div><img src="upload_pic/T_2_'.$oid.'.jpg" style="float:right;height:15px;opacity:0.6" /></li>';
	}
	else {
